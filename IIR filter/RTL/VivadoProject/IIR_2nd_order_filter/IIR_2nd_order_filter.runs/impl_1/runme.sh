...
HD_PWD='D:/college/Post_Grad_Studies/FPGA/IIR_2nd_order_filter/IIR_2nd_order_filter.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log IIR_filter.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source IIR_filter.tcl -notrace
