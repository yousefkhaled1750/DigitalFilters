...
% after deciding the registers' width
...
fid_input  = fopen('input_samples_1st_IIR.txt','w+');
fid_output = fopen('output_ref_1st_IIR.txt','w+');
fid_coeffs = fopen('coefficients_1st_IIR.txt','w+');
